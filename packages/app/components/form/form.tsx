...
const Form = ({
  ...
  inputsConfig.forEach((input) => {
    const config = 'preset' in input ? { ...getInputPreset(input.preset), name: input.name, labelText: input.labelText, options: input.options } : input;
  ...
  const validateInput = (name: string) => {
    ...
    if (inputConfig) {
      const config = 'preset' in inputConfig ? { ...getInputPreset(inputConfig.preset), name: inputConfig.name, labelText: inputConfig.labelText, options: inputConfig.options } : inputConfig;
